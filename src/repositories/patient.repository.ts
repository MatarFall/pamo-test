...
> {
  ...
  public readonly fichemedicale: HasOneRepositoryFactory<
    Fichemedicale,
    typeof User.prototype.userId
  >;
  ...
  constructor(
    ...
    @repository.getter('FichemedicaleRepository')
    protected fichemedicaleRepositoryGetter: Getter<FichemedicaleRepository>,
    @repository.getter('MedecinRepository')
    protected medecinRepositoryGetter: Getter<MedecinRepository>,
    ...
    this.fichemedicale = this.createHasOneRepositoryFactoryFor(
      'fichemedicale',
      fichemedicaleRepositoryGetter,
    );
    this.registerInclusionResolver(
      'fichemedicale',
      this.fichemedicale.inclusionResolver,
    );
